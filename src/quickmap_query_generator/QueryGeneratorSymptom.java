...
public class QueryGeneratorSymptom {
	public void generate(String filePath, String sqlPath, int nSep) throws IOException {
		...
		while((line = bufReader.readLine()) != null) {
			...
			//insert into qm_symptom (symptom_id, service_id, symptom_name) values (0, 0, '배가');
			String   insert_query	=
					"into qm_symptom "
					+ 	"(symptom_id, service_id, symptom_name)"
					+ "values "
					+ 	"(" + cntTotal + ", " + arr[0] + ", '" + arr[1] + "')\n";
